...
def register(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            profile.user = user   #linking profile with user
            profile.save()
    ...
    return render(request, 'app_users/registration.html', {'registered':registered, 
                                                            'user_form':user_form, 
...
def user_login(request):
    if request.method == "POST":
        ...
        if user:
            ...
            return HttpResponse("Please use correct id or password")
